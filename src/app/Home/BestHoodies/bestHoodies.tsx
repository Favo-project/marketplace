...
const products = [
  {
    img: "https://cottonon.com/dw/image/v2/BBDS_PRD/on/demandware.static/-/Sites-catalog-master-women/default/dw0729b976/2053953/2053953-02-2.jpg?sw=640&sh=960&sm=fit",
    name: "What",
    price: "200",
    sizes: ["x", "x", "x"],
  },
  {
    img: "https://www.firelabel.co.uk/Assets/User/AutoUpload/Gildan/Model%20Images/18500.jpg",
    name: "What",
    price: "200",
    sizes: ["x", "x", "x"],
  },
